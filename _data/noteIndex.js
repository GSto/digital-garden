module.exports = {
  ...
  },
  {
    ...
    notes: [
      { note: "article ideas"},
      { note: "digital garden"},
      { note: "digital writing", children: [
        { note: "digital garden"},
        { note: "learn in public"},
      ]},
      { note: "documentation"},
      { note: "evergreen notes", children: [
  ...
  },
  {
    title: "Communication",
    notes: [
      { note: "friendliness", children: [
        { note: "friendliness reading list" }
      ]},
      { note: "how to say no"},
      { note: "humor"},
    ]
  ...
  },
  {
    ...
    notes: [
      { note: "housing prices"},
      { note: "personal finance", children: [
        { note: "401k valuation"},
...
},
{
  ...
  notes: [
    ...
    { note: "organizational literacy", children: [
  ...
  },
  {
    ...
    notes: [
     ...
     { note: "thought exercises", children: [
